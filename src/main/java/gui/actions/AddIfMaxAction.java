    ...
    public void actionPerformed(ActionEvent e) {
        ...
        while(true){
            int result = JOptionPane.showOptionDialog(
                    null,
                    form,
                    GUIController.resourceBundle.getString("add_if_max"),
                    JOptionPane.YES_NO_OPTION,
                    JOptionPane.PLAIN_MESSAGE,
                    null,
                    new String[]{GUIController.resourceBundle.getString("add_if_max")},
                    GUIController.resourceBundle.getString("add_if_max")
            );
            ...
            if(result == JOptionPane.YES_NO_OPTION){
                if(form.checkValidity()){
                    ...
                    Request request = new Request("add_if_max", element, controller.getUserName(), true);
